...
public interface PdfMessageWatermarkService
{
    void watermark(final String documentSourcePath, final String documentOutputPath, final String watermarkText) throws Exception;
}