 ...
 */
public class PdfImageWatermarkServiceImpl implements PdfImageWatermarkService
{
    private final ImageWatermarkStrategy imageWatermarkStrategy;

    private final PdfWatermarkService pdfWatermarkService;

    public PdfImageWatermarkServiceImpl(final ImageWatermarkStrategy imageWatermarkStrategy, final PdfWatermarkService pdfWatermarkService)
    {
        this.imageWatermarkStrategy = imageWatermarkStrategy;
    ...
    {
        pdfWatermarkService.watermark(documentSourcePath, documentOutputPath, imageWatermarkStrategy);
    }
}
