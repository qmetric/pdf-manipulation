 ...
 * 1T3XT, 1T3XT DISCLAIMS THE WARRANTY OF NON INFRINGEMENT OF THIRD PARTY RIGHTS. <br/><br/>This program is distributed in the hope that it will be useful, but WITHOUT ANY
 ...
 * Franklin Street, Fifth Floor, Boston, MA, 02110-1301 USA, or download the license from the following URL: http://itextpdf.com/terms-of-use/ <br/><br/>The interactive user
 ...
 * License. <br/><br/>In accordance with Section 7(b) of the GNU Affero General Public License, you must retain the producer line in every PDF that is created or manipulated using
 * iText. <br/><br/>You can be released from the requirements of the license by purchasing a commercial license. Buying such a license is mandatory as soon as you develop
