...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="xs" version="2.0">
    ...
    <!-- <xsl:import href="WelcomePropertySets.xsl"/>-->
    ...
    <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>MK15012012 - changes to layout to cater for payment details</xd:p>
    ...
    <xsl:template match="/welcome-letter">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="welcomeLetterFirst" page-height="29.7cm" page-width="21cm" margin-top="10mm">
                    <fo:region-body margin-top="18mm" margin-bottom="31mm"/>
                    <fo:region-before region-name="header" extent="18mm"/>
                    <fo:region-after region-name="footer" extent="32mm" display-align="after"/>
                </fo:simple-page-master>

                <fo:simple-page-master master-name="welcomeLetterRest" page-height="29.7cm" page-width="21cm" margin-top="10mm">
                    <fo:region-body margin-top="32mm" margin-bottom="31mm"/>
                ...
                <fo:page-sequence-master master-name="welcomeLetter">
                    <fo:repeatable-page-master-alternatives>
                        <fo:conditional-page-master-reference master-reference="welcomeLetterFirst" page-position="first"/>
                        <fo:conditional-page-master-reference master-reference="welcomeLetterRest" page-position="rest"/>
                    </fo:repeatable-page-master-alternatives>
                    ...
                    <fo:block-container display-align="after" block-progression-dimension="100%">
                        <fo:block-container absolute-position="absolute" block-progression-dimension="100%" inline-progression-dimension="100%" left="0" top="0">
                            <fo:block>
                                ...
                                <!--<fo:external-graphic src="assets/bottom-of-page.png" content-width="210mm"/>-->
                            </fo:block>
                        </fo:block-container>
                        <fo:block-container absolute-position="absolute" block-progression-dimension="100%" inline-progression-dimension="100%" left="0" top="0">
    ...
    <xsl:template name="PolicyReference">
        <fo:table table-layout="fixed" width="210mm">
            <!-- margin column -->
            ...
            <fo:table-body>
                ...
                <fo:table-row height="12mm">
                    <fo:table-cell number-columns-spanned="4">
                        <xsl:apply-templates select="reference/account-number"/>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-body>
        </fo:table>
        <fo:block padding-after="1.7em"/>
    </xsl:template>
    ...
    <xsl:template match="reference">
        <fo:block xsl:use-attribute-sets="reference">
            <fo:instream-foreign-object content-width="82mm">
                <svg version="1.1" id="reference" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="509px" height="416px" viewBox="0 0 509 416" enable-background="new 0 0 509 416">
                    ...
                    <text transform="matrix(1 0 0 1 77.875 112)" font-family="'Arial'" font-size="20" fill="#191919">
                        ...
                        <tspan x="0" y="24" fill="#CF028D"><xsl:value-of select="policy-online/line[2]"/></tspan>
                        <tspan x="0" y="57"><xsl:value-of select="policy-change/line[1]"/></tspan>
                        <tspan x="0" y="81" fill="#CF028D"><xsl:value-of select="policy-change/line[2]"/></tspan>
                        <tspan x="0" y="115"><xsl:value-of select="email-address/line[1]"/></tspan>
                        <tspan x="0" y="139" fill="#CF028D"><xsl:value-of select="email-address/line[2]"/></tspan>
                    </text>
                </svg>
    ...
    <xsl:template match="reference/account-number">
        <fo:block>
            <fo:instream-foreign-object>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="431.833px" height="28.425px" viewBox="0 0 431.833 28.425" enable-background="new 0 0 431.833 28.425">
                    <g id="gray-bar">
                        <path fill="#E6E6E6" stroke="#FFFFFF" stroke-width="2" d="M431.63,17.203c0,6.401-5.622,11.591-12.556,11.591H142.13
                  		c-6.934,0-12.555-5.189-12.555-11.591v-5.928c0-6.401,5.621-11.591,12.555-11.591h276.944c6.934,0,12.556,5.189,12.556,11.591
                  		V17.203z"/>
                    </g>
                    <g id="purple-bar">
                  	<path fill="#A52392" stroke="#FFFFFF" stroke-width="2" d="M286.821,17.203c0,6.401-6.349,11.591-14.179,11.591h-312.74
                  		c-7.83,0-14.178-5.189-14.178-11.591v-5.928c0-6.401,6.348-11.591,14.178-11.591h312.74c7.83,0,14.179,5.189,14.179,11.591V17.203z
                  		"/>
                    </g>
                    <g id="text">
                        <text transform="matrix(1 0 0 1 29.0933 18.0137)" font-family="Arial" font-size="10pt" fill="#FFFFFF">
                            <tspan x="0" y="0"><xsl:value-of select="label"/></tspan>
                            <tspan x="124.605" y="0" font-weight="bold"><xsl:value-of select="number"/></tspan>
                        </text>
                        <text transform="matrix(1 0 0 1 295.0938 18.0137)" fill="#CF028D" font-family="'Arial'" font-size="10pt">
                            <xsl:value-of select="../letter-date/label"/>
                            <xsl:text> </xsl:text>
                            <xsl:value-of select="../letter-date/date"/>
                        </text>
                    </g>
                </svg>
            </fo:instream-foreign-object>
    ...
    <xsl:template match="table">
        ...
        <fo:table table-layout="fixed" width="190mm" xsl:use-attribute-sets="table">
            <fo:table-column column-width="proportional-column-width(1.3)" column-number="1"/>
            <fo:table-column column-width="proportional-column-width(0.8)" column-number="2"/>
            <fo:table-column column-width="proportional-column-width(0.9)" column-number="3"/>
            <fo:table-column column-width="proportional-column-width(1.1)" column-number="4"/>
            <fo:table-column column-width="proportional-column-width(0.9)" column-number="5"/>
    ...
    <xsl:template match="payment-info">
        <fo:block xsl:use-attribute-sets="payment-info">
            <fo:block xsl:use-attribute-sets="payment-info.title">
                <xsl:value-of select="title"/>
            </fo:block>
            <fo:table table-layout="fixed" width="190mm" xsl:use-attribute-sets="margin-reset">
                <fo:table-column column-width="92.5mm" column-number="1"/>
                <fo:table-column column-width="7.5mm" column-number="2"/>
                <fo:table-column column-width="90mm" column-number="3"/>
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell xsl:use-attribute-sets="margin-reset">
                            <fo:block>
                                <!-- Card payment table -->
                                <fo:instream-foreign-object>
                                    <svg version="1.1" id="card-payment-table" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="256px" height="57.5px" viewBox="0 0 256 57.5" enable-background="new 0 0 256 57.5">
                                        <rect x="-0.228" y="17.359" fill="#E6E6E6" width="255.118" height="39.686"/>
                                        <rect x="-0.228" y="0.46" fill="#C5E5F7" width="255.118" height="17.008"/>
                                        <line fill="none" stroke="#FFFFFF" x1="98.25" y1="57.045" x2="98.25" y2="17.25"/>
                                        <circle fill="#CBDB2A" stroke="#FFFFFF" stroke-width="1" cx="220.75" cy="30.464" r="22.786"/>
                                        <path id="tick" fill="#FFFFFF"
                                            d="M233.648,19.468c-0.145,0.031-0.272,0.091-0.39,0.186l-18.052,13.525l-7.703-6.511
                                        	c-0.386-0.325-0.922-0.302-1.284,0.065c-0.361,0.364-0.447,0.956-0.202,1.428l8.284,15.126c0.158,0.317,0.44,0.526,0.764,0.565
                                        	c0.316,0.05,0.634-0.081,0.854-0.349l18.634-22.103c0.317-0.356,0.383-0.9,0.18-1.339C234.525,19.623,234.082,19.385,233.648,19.468
                                        	z"/>
                                        <text transform="matrix(1 0 0 1 5.9998 11)" font-weight="bold" font-family="Arial" font-size="7.5pt">
                                            <xsl:value-of select="card-details/title"/>
                                        </text>
                                        <text transform="matrix(1 0 0 1 6.2498 27.25)" font-family="Arial" font-size="7.5pt">
                                            <tspan x="0" y="0">
                                                <xsl:if test="payment-method eq 'Annual'">
                                                    <xsl:value-of select="card-details/full/label"/>
                                                </xsl:if>
                                                <xsl:if test="payment-method eq 'Direct Debit'">
                                                    <xsl:value-of select="card-details/deposit/label"/>
                                                </xsl:if>
                                            </tspan>
                                            <tspan x="0" y="12">
                                                <xsl:value-of select="card-details/card-number/label"/>
                                            </tspan>
                                        </text>
                                        <text transform="matrix(1 0 0 1 104.2498 27.25)" font-family="Arial" font-size="7.5pt" fill="#CF028D">
                                            <tspan x="0" y="0">
                                                <xsl:if test="payment-method eq 'Annual'">
                                                    <xsl:value-of select="card-details/full/amount"/>
                                                </xsl:if>
                                                <xsl:if test="payment-method eq 'Direct Debit'">
                                                    <xsl:value-of select="card-details/deposit/amount"/>
                                                </xsl:if>
                                            </tspan>
                                            <tspan x="0" y="12">
                                                <xsl:value-of select="card-details/card-number/number"/>
                                            </tspan>
                                        </text>
                                    </svg>
                                </fo:instream-foreign-object>
                        ...
                        <fo:table-cell xsl:use-attribute-sets="margin-reset">
                            <fo:block/>
                            <xsl:if test="direct-debit">
                                <fo:block xsl:use-attribute-sets="payment-info.plus">+</fo:block>
                            </xsl:if>
                        </fo:table-cell>
                        <fo:table-cell xsl:use-attribute-sets="margin-reset">
                            <fo:block>
                                ...
                                <xsl:if test="direct-debit">
                                    <fo:instream-foreign-object>
                                        <svg version="1.1" id="direct-debit-table" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="254.75px" height="57.5px" viewBox="0 0 254.75 57.5" enable-background="new 0 0 254.75 57.5">
                                            <rect x="-0.228" y="17.359" fill="#E6E6E6" width="255.118" height="39.686"/>
                                            <rect x="-0.228" y="0.46" fill="#C5E5F7" width="255.118" height="17.008"/>
                                            <line fill="none" stroke="#FFFFFF" x1="98.25" y1="57.045" x2="98.25" y2="17.25"/>
                                            <circle fill="#E85B23" stroke="#FFFFFF" stroke-width="1" cx="220.75" cy="30.464" r="22.786"/>
                                            <text transform="matrix(1 0 0 1 5.9998 11)" font-family="Arial" font-weight="bold" font-size="7.5pt">
                                                <xsl:value-of select="direct-debit/title"/>
                                            </text>
                                            <text transform="matrix(1 0 0 1 6.2498 27.25)" font-family="Arial" font-size="7.5pt">
                                                <tspan x="0" y="0">
                                                    <xsl:value-of select="direct-debit/installments/label"/>
                                                </tspan>
                                                <tspan x="0" y="12">
                                                    <xsl:value-of select="direct-debit/finance-company/label"/>
                                                </tspan>
                                                <tspan x="0" y="24">
                                                    <xsl:value-of select="direct-debit/questions/label"/>
                                                </tspan>
                                            </text>
                                            <text transform="matrix(1 0 0 1 104.2498 27.25)" font-family="Arial" font-size="7.5pt" fill="#CF028D">
                                                <tspan x="0" y="0">
                                                    <xsl:value-of select="direct-debit/installments/amount"/>
                                                </tspan>
                                                <tspan x="0" y="12">
                                                    <!-- Limit string length to 27 to prevent text overrun -->
                                                    <xsl:value-of select="substring(direct-debit/finance-company/name, 0, 27)"/>
                                                </tspan>
                                                <tspan x="0" y="24">
                                                    <xsl:value-of select="direct-debit/questions/tel"/>
                                                </tspan>
                                            </text>
                                            <text transform="matrix(1 0 0 1 211.5779 20)" font-family="Arial" fill="#FFFFFF" font-size="6pt">
                                                <tspan x="0" y="0">To pay</tspan>
                                                <tspan x="3.336" y="6.2">over</tspan>
                                                <tspan x="5.279" y="13.6" font-weight="bold" font-size="7pt">10</tspan>
                                                <tspan x="-3.466" y="21" font-weight="bold" font-size="7pt">months</tspan>
                                            </text>
                                        </svg>
                                    </fo:instream-foreign-object>
                                </xsl:if>
    ...
    <xsl:template match="valediction/name">
        <fo:block xsl:use-attribute-sets="valediction.name">
            <fo:block>
                <fo:external-graphic content-height="22mm" src="res:document/template/welcome/assets/signature.jpg"/>
            </fo:block>
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template name="PolicyExpertLogo">
        <fo:instream-foreign-object content-height="12mm">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="141.904px" height="34.588px" viewBox="0 0 141.904 34.588" enable-background="new 0 0 141.904 34.588" xml:space="preserve">
                <g>
